...
Once your team meets these criteria, you can create a GitHub [issue](https://github.com/cncf/kubernetes-community-days/issues/new?assignees=christinevblum%2C+iennae&labels=newevent&template=host.md) to notify CNCF that you wish to be officially recognized. Your organizing team will be invited to the [#kcd-organizers](https://cloud-native.slack.com/messages/GN6R2PV1A) private Slack channel where you can connect with other Kubernetes Community Days organizers around the world. You can then begin creating your website. Copy the page structure of the [Bouvet Island](/events/2020-bouvet-island) sample event as a guide. Instructions are [here](/organizing-creating-website).

## Event Details

Events may be developer focused or they can focus on business issues and cloud strategy. Attendance averages 100-400 people. Most start small and grow slowly. Again, Kubernetes Community Days are not to be used for commercial pitches. Any platforms or tools you are describing need to be open source. That said, many (most?) talks will be about how companies relied on open source technologies to improve their processes. Event profits must be reinvested in future events. Organizers should be reimbursed for their actual expenses, not for their time.
...
* Registration and sponsorship need to be available to anyone until the available capacity sells out
...
The first step towards a successful event is building a team. Look for potential team members in local user groups and meetups, such as the [CNCF Meetup groups](https://www.meetup.com/pro/cncf/), or online in the public [Kubernetes Slack](https://slack.k8s.io/) or other related online communities.
...
* [Website updates](/organizing-creating-website)
